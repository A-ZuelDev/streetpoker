  ...
  return {
    room: {
      ...
      settings: {
        ...
        timebank_refill_amount_ms: 60_000,
        timebank_refill_every_hands: 1,
...
export function activeRoomSnapshot(roomName = 'Friday Night'): RoomView {
  ...
  snapshot.active_hand = {
    ...
    action_timer_remaining_ms: 30_000,
    current_actor_timebank_ms: 60_000,
    current_actor_timebank_total_ms: 60_000,
    current_actor_using_timebank: false,
    timebank_refill_amount_ms: 60_000,
    timebank_refill_hands_remaining: 1,
    phase: 'flop',
    button_seat: 2,
    small_blind_seat: 0,
    big_blind_seat: 1,
